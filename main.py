...
wav_directory = '/mnt/4d55e72b-7ce5-4fc5-b3d4-3cfd1a4a0281/Afshari/vox/vox2_mini_converted'
...
for i in range(0, len(wav_file_paths), batch_size):
    ...
    # Initialize lists to store representations for the batch
    batch_representations = []
    batch_layer_results = []
    batch_layer_reps = []
    
    for wav_file_path in batch_paths:
        print(f"second loop{wav_file_path}")
        # Load the audio file
